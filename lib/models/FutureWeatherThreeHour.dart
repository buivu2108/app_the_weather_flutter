class FutureWeatherThreeHour {
  ...
  FutureWeatherThreeHour.fromJson(Map<String, dynamic> json) {
    cod = json['cod'] as String?;
    message = json['message'];
    cnt = json['cnt'];
    listWeather = (json['list'] as List?)?.map((dynamic e) => ListWeather.fromJson(e as Map<String,dynamic>)).toList();
  ...
  Map<String, dynamic> toJson() {
    ...
    json['cnt'] = cnt;
    json['list'] = listWeather?.map((e) => e.toJson()).toList();
